...
function StatusButtons({user, book}) {
  ...
  // since this is async, it will be empty until the object comes populated
  // which is why the elvis operator is there - it won't execute till listItems is there
